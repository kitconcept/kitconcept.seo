...
#
#  $ bin/test -s kitconcept.seo -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src kitconcept.seo.testing.KITCONCEPT_SEO_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/kitconcept/seo/tests/robot/test_example.robot
#
